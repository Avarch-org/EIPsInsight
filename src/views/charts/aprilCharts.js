    ...
    <CRow>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/aprilDraftTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/aprilFinalTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/aprilReviewTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/aprilLastCallTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/aprilStagnantTable" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <CCol xs={6}>
        <CCard className="mb-4">
          <Link to="/aprilWithdrawnTable" style={{ textDecoration: 'none', color: 'inherit' }}>
